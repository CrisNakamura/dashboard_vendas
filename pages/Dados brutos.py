...
st.set_page_config(page_title='Dados Brutos', page_icon=':shopping_trolley:', layout='wide')
...
with coluna1:
    ...
    nome_arquivo += '.csv'
with coluna2:
    st.download_button('Fazer o download da tabela em csv', data = convert_csv(dados_filtrados),file_name=nome_arquivo, mime='text/csv', on_click= message_sucesso)
